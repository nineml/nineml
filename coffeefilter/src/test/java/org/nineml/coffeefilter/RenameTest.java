...
public class RenameTest {
    ...
    public void renameAtoB_11() {
        ...
        Assertions.assertEquals("<S><B>b</B></S>", doc.getTree());
    }
    ...
    public void renameAtoBCD_11() {
        ...
        Assertions.assertTrue(doc.succeeded());
        //System.err.println(doc.getTree());
        Assertions.assertEquals("<S B='b' C='d'><C>c</C><D>d</D><B>b</B><B>c</B></S>", doc.getTree());
    }
    ...
    public void renameAtoBCD_pragma_simple() {
        ...
        Assertions.assertTrue(doc.succeeded());
        //System.err.println(doc.getTree());
        Assertions.assertEquals("<S><X>x</X><Y>y</Y><Z>z</Z></S>", doc.getTree());
    }
    ...
    public void renameAtoBCD_pragma_combined() {
        ...
        Assertions.assertEquals("<S B='b' Z='d'><Y>c</Y><Z>d</Z><Z>d</Z><W>b</W><B>c</B></S>", doc.getTree());
    }
    ...
    public void dupRenameRule() {
        ...
        Assertions.assertEquals("E016", iex.getCode());
    }
