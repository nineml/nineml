...
public class ParserTest {
    ...
    public void parseDate() {
        ...
        try {
            ...
            Assertions.assertEquals("16June67", node.getStringValue());

            String str = node.toString();

            Assertions.assertTrue(str.contains("<date>"));
            Assertions.assertTrue(str.contains("<day>16</day>"));
            Assertions.assertTrue(str.contains("<month>June</month>"));
            Assertions.assertTrue(str.contains("<year>67</year>"));
    ...
    public void hash() {
        try {
            ...
            String str = node.toString();
            Assertions.assertEquals("#.", node.getStringValue());

            Assertions.assertTrue(str.contains("<hash d6='12'>") || str.contains("<hash d6=\"12\">"));
        } catch (Exception ex) {
            System.err.println(ex.getMessage());
            fail();
        }
    ...
    public void vcard() {
        try {
            ...
            Assertions.assertTrue(str.contains("<property name='ORG'>") || str.contains("<property name=\"ORG\">"));      // random spotchecks
            Assertions.assertTrue(str.contains("<attribute value='EVenX'/>") || str.contains("<attribute value=\"EVenX\"/>"));
        } catch (Exception ex) {
            System.err.println(ex.getMessage());
            fail();
        }
    ...
    public void css() {
        try {
            ...
            Assertions.assertEquals("<css><rule><selector><name>body</name></selector><block><property name='color'><value name='blue'/></property><property/></block></rule></css>",
                    str);
        } catch (Exception ex) {
            System.err.println(ex.getMessage());
            fail();
    ...
    public void ambig2() {
        try {
            ...
            Assertions.assertTrue(xml.startsWith("<a"));
            Assertions.assertTrue(xml.endsWith("/>"));
        } catch (Exception ex) {
            System.err.println(ex.getMessage());
            fail();
        }
