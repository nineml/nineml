...
public class SimpleTreeTest extends CommonBuilder {
    ...
    public void emptyTree() {
        ...
        Assertions.assertTrue(tree.getAttributes().isEmpty());
    ...
    public void treeWithTextNode() {
        try {
            ...
            Assertions.assertTrue(tree.getChildren().get(0) instanceof SimpleText);
            Assertions.assertEquals("abc", tree.getChildren().get(0).getText());
        } catch (Exception ex) {
            fail();
        }
    }
    ...
    public void treeWithNode() {
        try {
            ...
            Assertions.assertTrue(textNode instanceof SimpleText);
            Assertions.assertEquals("abc", textNode.getText());
        } catch (Exception ex) {
            fail();
        }
    }
    ...
    public void treeWithWhitespace() {
        try {
            ...
            SimpleTree textNode = node.getChildren().get(0);
            Assertions.assertTrue(textNode instanceof SimpleText);
            Assertions.assertEquals("   ", textNode.getText());
        } catch (Exception ex) {
            fail();
        }
    }
    ...
    public void xmlSerializer() {
        try {
            ...
            Assertions.assertTrue(ok1.equals(xml) || ok2.equals(xml));
        } catch (Exception ex) {
            fail();
        }
    }
    ...
    public void jsonSerializer() {
        try {
            ...
            Assertions.assertEquals("{\"content\":{\"name\":\"root\",\"attributes\":{\"test\":\"spoon\"},\"content\":[{\"name\":\"attronly\",\"attributes\":{\"a\":1,\"b\":2}},{\"name\":\"node1\",\"content\":\"\\\"hello\\\"\"},{\"name\":\"node2\",\"content\":\"c:\\\\path\"},{\"name\":\"node3\",\"content\":\"/usr/local\"}]}}",
                    json);
        } catch (Exception ex) {
            fail();
        }
    ...
    public void jsonAttributes() {
        try {
            ...
            Assertions.assertEquals("{\"content\":{\"name\":\"root\",\"attributes\":{\"count\":2,\"version\":1.0},\"content\":[{\"name\":\"record\",\"attributes\":{\"num\":1},\"content\":[{\"name\":\"name\",\"content\":\"John Doe\"},{\"name\":\"age\",\"content\":25}]},{\"name\":\"record\",\"content\":[{\"name\":\"name\",\"content\":\"Mary Smith\"},{\"name\":\"age\",\"content\":22}]},{\"name\":\"no-content\",\"attributes\":{\"test\":\"string\"}},{\"name\":\"no-content-or-attr\"}]}}",
                    str);
        } catch (Exception ex) {
            fail();
        }
